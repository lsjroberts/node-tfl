...
Tube.prototype._get = function(endpoint, nodeNameFilter, pushCallback, elementsFilterCallback) {
    var endpoint
      , statuses
      , promise
    ;
...
Tube.prototype.lines.status = function(options) {
    ...
    promise = this._get(endpoint, 'LineStatus', function(node) {
        return {
...
Tube.prototype.line.arrivals = function(name) {
    ...
    promise = this._get(endpoint, 'S', function(node) {
        var platforms = []
          , platformNodes
          , trainNodes
        ;
